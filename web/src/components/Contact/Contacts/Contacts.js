        ...
        <tbody>
          {contacts.map((contact) => (
            <tr key={contact.id}>
              ...
              <td>{truncate(contact.contactname)}</td>
              <td>{truncate(contact.contactemail)}</td>
              <td>{truncate(contact.contactphone)}</td>
              <td>{truncate(contact.contactsuburb)}</td>
              <td>{truncate(contact.contactmessage)}</td>
              <td>
